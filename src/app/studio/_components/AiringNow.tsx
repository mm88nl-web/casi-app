...
export default function AiringNow({ items }: Props) {
  ...
  return (
    <section className="flex flex-col" style={{ gap: '10px' }}>
      <style>{`
        .casi-air-r { display: flex; align-items: center; gap: 14px; padding: 12px 16px 12px 12px; }
        .casi-air-end:hover { border-color: rgba(239,68,68,0.3) !important; color: #f87171 !important; }
        .casi-air-q { padding: 10px 16px 14px 70px; border-top: 1px solid var(--line); }
        .casi-air-q-row { display: flex; align-items: center; gap: 10px; padding: 8px 0; border-top: 1px dashed var(--line-2); }
