  ...
  return (
    <div style={{ marginTop: 24, background: 'rgba(192,132,252,0.05)', border: '1px solid rgba(192,132,252,0.2)', borderRadius: 12, padding: '14px 16px' }}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 10 }}>
        ...
        <span style={{ fontFamily: "var(--font-casi-mono), monospace", fontSize: 9, color: 'var(--casi-text-muted)' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
        {flashes.map(f => (
          <div key={f.id} style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '6px 8px', borderRadius: 8, background: 'rgba(0,0,0,0.3)', border: '1px solid rgba(192,132,252,0.15)' }}>
            <span style={{ fontFamily: "var(--font-casi-mono), monospace", fontSize: 10, fontWeight: 700, color: '#c084fc', background: 'rgba(192,132,252,0.1)', padding: '2px 6px', borderRadius: 4, flexShrink: 0, whiteSpace: 'nowrap' }}>
              {(f.amount_cents / 100).toFixed(0)} USDC
            </span>
            <span style={{ fontFamily: "var(--font-casi-sans), sans-serif", fontSize: 12, color: 'var(--casi-text)', flex: 1, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
      ...
      <div style={{ fontFamily: "var(--font-casi-mono), monospace", fontSize: 9, color: 'var(--casi-text-muted)', marginTop: 8, lineHeight: 1.5 }}>
