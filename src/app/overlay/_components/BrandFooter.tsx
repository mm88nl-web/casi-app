export default function BrandFooter() {
  return (
    <div style={{ marginTop: 36, paddingTop: 20, borderTop: '1px solid var(--casi-surface)', textAlign: 'center' }}>
      <a
        href="/search"
        style={{ fontFamily: "var(--font-casi-mono),monospace", fontSize: 10, letterSpacing: 2, textTransform: 'uppercase', color: '#222', textDecoration: 'none' }}
      >
        Browse other streams →
      </a>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6, marginTop: 20 }}>
        <span style={{ fontFamily: "var(--font-casi-mono),monospace", fontSize: 9, letterSpacing: 1.5, textTransform: 'uppercase', color: '#888' }}>Powered by</span>
        ...
        <span style={{ fontFamily: "var(--font-casi-mono),monospace", fontSize: 9, letterSpacing: 1.5, textTransform: 'uppercase', color: '#888' }}>Solana</span>
      </div>
    </div>
  );
}
