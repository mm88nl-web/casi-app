...
import AdminSlot from './_components/AdminSlot';
            ...
            <div className="canvas-wrap" ref={setMonitorRef}
              ...
              {dimensions.width > 0 && elements.map((el) => (
                <AdminSlot
                  ...
                  isSelected={selectedSlotId === el.id}
                  hasActiveOrQueued={
                    activeBookings.some(b => b.element_id === el.id) ||
                    approvedQueued.some(b => b.element_id === el.id)
                  }
                  onSelect={(id) => { setSelectedSlotId(id); setShowInfoPanel(false); }}
                  onMove={(id, pos) => updateLayer(id, pos)}
                  onResize={(id, box) => updateLayer(id, box)}
