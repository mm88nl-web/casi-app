...
export default function LegalLayout({ children }: { children: ReactNode }) {
  return (
    <div style={{ maxWidth: 820, margin: '0 auto', padding: '48px 20px 80px', fontFamily: "var(--font-casi-sans), ui-sans-serif, system-ui, sans-serif", color: '#e4e4e7' }}>
      <nav style={{ display: 'flex', gap: 16, flexWrap: 'wrap', fontFamily: "var(--font-casi-mono), monospace", fontSize: 12, letterSpacing: 1, textTransform: 'uppercase', marginBottom: 36, paddingBottom: 16, borderBottom: '1px solid #27272a' }}>
