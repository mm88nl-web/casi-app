...
type Props = {
  size?: number;
  /** Force a flat fill instead of the brand gradient — useful for monochrome
...
/**
 * Solana Logomark — Color variant. Sourced from the official Solana brand
 * kit (Logo.zip → Solana Logomark/SVG/Solana Logomark - Color.svg). Three
 * angled bars with the canonical 6-stop gradient (#9945FF → #19FB9B).
 *
 * The gradient id is derived from useId() so multiple instances on the
 * same page don't collide on the linearGradient ref.
 */
