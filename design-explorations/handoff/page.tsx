...
// Palette pinned here so the landing always renders in CASI dark even if a
// UserSkinProvider or SkinProvider has written different --ink / --paper onto
// <html> from a previous route visit in the same session.  The inline style on
// <main> scopes the override to this subtree only — nothing else is affected.
const CASI_DARK = {
  '--ink': '#0DCFB0',
  '--paper': '#0C0D11',
    ...
    <main className="casi-v9-landing" style={CASI_DARK}>
      ...
      <style jsx>{`
        ...
        @media (min-width: 760px) {
          .l-band { grid-template-columns: repeat(3, 1fr); }
        }
        .l-band-cell {
        ...
        .l-band-cell:last-child { border-right: none; }
        ...
        @media (max-width: 540px) {
          .l-band-cell { padding: 36px 20px 40px; gap: 14px; }
        }
        .l-band-n {
          font-family: var(--M);
          font-size: 10.5px;
        ...
        .l-band-rails { display: flex; flex-direction: column; gap: 8px; }
        .l-rail {
          display: flex;
          align-items: center;
          gap: 12px;
        ...
        .l-rail-ghost { background: transparent; border-color: var(--line); }
        .l-rail-ico {
          width: 26px;
          height: 26px;
          display: flex;
        ...
        .l-rail-name { font-size: 13.5px; font-weight: 600; flex: 1; color: var(--text); }
        .l-rail-name-ghost { color: var(--text-3); }
        .l-rail-note { font-family: var(--M); font-size: 10px; color: var(--text-4); letter-spacing: 0.06em; }
        .l-band-flow { display: flex; flex-direction: column; gap: 10px; }
        .l-flow-row {
          display: flex;
          align-items: center;
          gap: 11px;
        ...
        .l-flow-row.ok { color: var(--text); }
        .l-flow-row.ok .l-flow-num { color: var(--ink); }
        ...
        @media (max-width: 540px) { .l-how { padding: 56px 20px; } }
        .l-how-hd {
          display: flex;
        ...
        @media (max-width: 540px) { .l-how-hd { margin-bottom: 32px; } }
        .l-how-title {
          font-family: var(--H);
          font-weight: 800;
        ...
        @media (min-width: 760px) {
          .l-how-grid { grid-template-columns: repeat(3, 1fr); }
        }
        .l-how-cell {
          padding: 32px 28px;
          border-right: 1px solid var(--line);
        ...
        .l-how-cell:last-child { border-right: none; }
        @media (max-width: 760px) {
          .l-how-cell { border-right: none; border-bottom: 1px solid var(--line); }
        }
        @media (max-width: 540px) { .l-how-cell { padding: 28px 20px; } }
        .l-how-n {
          font-family: var(--M);
          font-size: 11px;
          letter-spacing: 0.18em;
